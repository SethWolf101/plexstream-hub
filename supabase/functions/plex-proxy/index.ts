  ...
  try {
    switch (action) {
      ...
      case 'hls': {
        ...
        const hlsPath = `/video/:/transcode/universal/start.m3u8?path=${path}&mediaIndex=0&partIndex=0&protocol=hls&offset=0&fastSeek=1&copyts=1&directPlay=0&directStream=0&videoCodec=h264&audioCodec=aac&subtitleSize=100&subtitles=burn&audioBoost=100&maxVideoBitrate=20000&videoQuality=100&videoResolution=1920x1080&location=wan&mediaBufferSize=102400&session=${session}&X-Plex-Platform=Chrome&X-Plex-Device=Chrome&X-Plex-Device-Name=Seths%20Streams&X-Plex-Client-Identifier=seths-streams-${session}&X-Plex-Product=Seths%20Streams&X-Plex-Version=1.0`;
